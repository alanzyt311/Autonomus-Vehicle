...
class PurePursuit(object):
    ...
    def inspva_callback(self, inspva_msg):
        ...
        # print("callback", self.lat, self.lon, self.heading)
    ...
    def read_waypoints(self):
        ...
        # if you want to record a new path, use source1;
        # if you want to use a prerecord path, use source2.
        # filename = os.path.join(dirname, '../waypoints/xy_demo.csv') # source1
        filename = os.path.join(dirname, '../waypoints/fig8.csv') # source2
    ...
    def start_pp(self):
        ...
        while not rospy.is_shutdown():
            ...
            info = f'{curr_x},{curr_y},{self.heading}\n'
            f.write(info)
            ...
            for idx in goal_arr:
                ...
                if abs(temp_angle) < np.pi/2:
                    if (idx < 10 or abs(self.goal - idx) <= 50 ):
                    self.goal = idx
                    break
